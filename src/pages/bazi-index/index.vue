...
async function baiAiAsk() {
  ...
  var bubbleHTML = '<div class="chat-bubble-ai" id="' + bubbleId + '">' +
    '<div class="ai-stage" id="baiStage"><img class="ai-stage-logo" id="baiStageLogo" src="/static/images/logo.svg?v=7"><span id="baiStageText">排盘准备中</span></div>' +
...
async function baiSendFollowUp() {
  ...
  aiBubble.innerHTML = '<div class="ai-stage"><img class="ai-stage-logo" src="/static/images/logo.svg?v=7"><span>AI思考中...</span></div><div class="ai-progress-bar"><div class="ai-progress-fill" style="width:10%"></div></div><div class="chat-bubble-content"></div>'
